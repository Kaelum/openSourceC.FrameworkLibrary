...
namespace openSourceC.FrameworkLibrary.Data
{
	...
	/// </summary>
	public sealed class SqlParamsHelper : ParamsHelper<SqlDbFactoryCommand, SqlParamsHelper, SqlDataReaderHelper, SqlConnection, SqlTransaction, SqlCommand, SqlParameter, SqlDataAdapter, SqlDataReader>
	{
		...
		/// <summary>
		///		Add a parameter representing a variable-length varchar(max) to the command object.
		/// </summary>
		...
		/// <summary>
		///		Add a parameter representing a variable-length nvarchar(max) or UTF-16 encoded XML
