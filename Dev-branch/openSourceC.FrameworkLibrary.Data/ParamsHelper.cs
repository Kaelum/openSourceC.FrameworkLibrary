...
namespace openSourceC.FrameworkLibrary.Data
{
	...
	public abstract class ParamsHelper<TDbFactoryCommand, TParamsHelper, TDataReaderHelper, TDbConnection, TDbTransaction, TDbCommand, TDbParameter, TDataAdapter, TDbDataReader> : IDisposable
		...
		where TDbDataReader : DbDataReader
	{
		...
		/// <summary>
		///		Create a new <see cref="T:TParamsHelper"/> object.
		/// </summary>
		/// <param name="command">A <see cref="T:TDbCommand"/>.</param>
		///	<returns>
		///		A new <see cref="T:TParamsHelper"/> object.
		///	</returns>
		internal static TParamsHelper Create(TDbCommand command)
		{
			TParamsHelper paramsHelper = new TParamsHelper();
		...
		/// <summary>
		///		Add a parameter representing a variable length ANSI string to the command object.
		/// </summary>
		///	<param name="parameterName">The name of the parameter.</param>
			...
			where TEnum : struct
		{
			...
			if (underlyingType.Equals(typeof(Int64))) { dbType = DbType.Int64; }
			else if (underlyingType.Equals(typeof(UInt64))) { dbType = DbType.UInt64; }
			else if (underlyingType.Equals(typeof(Int32))) { dbType = DbType.Int32; }
			else if (underlyingType.Equals(typeof(UInt32))) { dbType = DbType.UInt32; }
			else if (underlyingType.Equals(typeof(Int16))) { dbType = DbType.Int16; }
			else if (underlyingType.Equals(typeof(UInt16))) { dbType = DbType.UInt16; }
			else if (underlyingType.Equals(typeof(Byte))) { dbType = DbType.Byte; }
			else if (underlyingType.Equals(typeof(SByte))) { dbType = DbType.SByte; }
			else
			{
				throw new OscErrorException(string.Format("Unexpected TEnum ({0}) value type of {1}.", typeof(TEnum).FullName, Enum.GetUnderlyingType(typeof(TEnum)).FullName));
			}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddSingle(string parameterName, ParameterDirection direction = ParameterDirection.Input)
		{
			return AddSingle(parameterName, true, null, direction);
		}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddSingle(string parameterName, bool isNullable, double? value, ParameterDirection direction = ParameterDirection.Input)
		{
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddSingle(string parameterName, string sourceColumn, ParameterDirection direction = ParameterDirection.Input)
		{
			return AddSingle(parameterName, sourceColumn, false, direction);
		}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddSingle(string parameterName, string sourceColumn, bool sourceColumnIsNullable, ParameterDirection direction = ParameterDirection.Input)
		{
			TDbParameter prm = AddSingle(parameterName, true, null, direction);
			prm.SourceColumn = sourceColumn;
			prm.SourceColumnNullMapping = sourceColumnIsNullable;
		...
		/// <summary>
		///		Add a parameter representing a variable length UNICODE string to the command object.
		/// </summary>
		///	<param name="parameterName">The name of the parameter.</param>
		///	<param name="size"> The size of the parameter (width of the column). </param>
		///	<param name="direction">The parameter direction. (optional)</param>
		...
		/// <summary>
		///		Add a parameter representing a fixed length UNICODE string to the command object.
		/// </summary>
		///	<param name="parameterName">The name of the parameter.</param>
		///	<param name="size"> The size of the parameter (width of the column). </param>
		///	<param name="direction">The parameter direction. (optional)</param>
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddTime(string parameterName, ParameterDirection direction = ParameterDirection.Input)
		{
			return AddTime(parameterName, true, null, direction);
		}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddTime(string parameterName, bool isNullable, DateTime? value, ParameterDirection direction = ParameterDirection.Input)
		{
			return CreateParameter(DbType.Time, parameterName, isNullable, value, direction);
		}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddTime(string parameterName, string sourceColumn, ParameterDirection direction = ParameterDirection.Input)
		{
			return AddTime(parameterName, sourceColumn, false, direction);
		}
		...
		///	<param name="direction">The parameter direction. (optional)</param>
		///	<returns>Returns a <typeparamref name="TDbParameter"/> object.</returns>
		public TDbParameter AddTime(string parameterName, string sourceColumn, bool sourceColumnIsNullable, ParameterDirection direction = ParameterDirection.Input)
		{
			TDbParameter prm = AddTime(parameterName, true, null, direction);
			prm.SourceColumn = sourceColumn;
			prm.SourceColumnNullMapping = sourceColumnIsNullable;
